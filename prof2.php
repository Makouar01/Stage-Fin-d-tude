...
<body>
  ...
  <div class="col-lg-6">
    <ul class="nav nav-pills">
        ...
        <li class="active"><a href="prof2.php">Enseignant</a></li>
...
$sql = "SELECT * FROM prof WHERE sup = 1";
$result = $conn->query($sql);
?>

<div class='col-lg-12'>
<h3  id='logoright'>Liste des Enseignants</h3>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ?>
        <tr><td><?=$row["nom_prof"]?></td>
        <td><?=$row["cni"]?></td>
        <td><?=$row["departement"]?></td>
        <td>
      <a href="edit_prof.php?id=<?=$row['id_prof']?>"><img src="IMG/pen.png" width="25"></a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

    <a onclick="return confirm('êtes-vous sûr de vouloir supprimer ce professeur')" href="supprimerpf.php?id=<?=$row['id_prof']?>"><img src="IMG/trash.png" width="25"></a></td>
...
<ul class='nav nav-pills'>
    ...
    <li><a href='add_ensg.php'>Ajouter un Enseignant</a></li>
    </br>
